...
{
    Task<UserResultDto> CreateUserAsync(UserProfileDto user, string password, bool isAdmin = false);
    ...
    Task AddRoleAsync(string userId, string v);
    Task RemoveRoleAsync(string userId, string v);
}
